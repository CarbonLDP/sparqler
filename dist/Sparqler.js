...
var QueryBuilder = (function () {
    ...
    QueryBuilder.prototype.base = function (iri) {
        this._base = iri;
        return this.interfaces.queryClause;
    };
    QueryBuilder.prototype.vocab = function (iri) {
        this._vocab = iri;
        return this.interfaces.queryClause;
    };
    QueryBuilder.prototype.prefix = function (name, iri) {
    ...
    QueryBuilder.prototype.groupBy = function (rawCondition) {
    ...
    QueryBuilder.prototype.having = function (rawCondition) {
    ...
    QueryBuilder.prototype.orderBy = function (rawCondition) {
    ...
    QueryBuilder.prototype.getCompactSparqlQuery = function () {
        return this.constructQuery(Token_1.TokenFormat.COMPACT);
    };
    QueryBuilder.prototype.getPrettySparqlQuery = function () {
        return this.constructQuery(Token_1.TokenFormat.PRETTY);
    };
    QueryBuilder.prototype.initInterfaces = function () {
        this.interfaces = {
            queryClause: {
    ...
    QueryBuilder.prototype._resolveIRI = function (iri, vocab) {
